...
<body ng-app="myApp" class="ng-cloak">
	<div class="generic-container"
		ng-controller="ActualizarController as ctrl">
				...
				<form ng-submit="ctrl.submit()" name="myForm"
							...
							<div class="col-md-7">
								...
								<div class="has-error" ng-show="myForm.$dirty">
									<span ng-show="myForm.nombreusuario.$error.required">Requiere
										...
										ng-show="myForm.nombreusuario.$invalid">Nombre de
						...
						<div class="form-group col-md-12">
							...
							<div class="col-md-7">
								<input type="password" ng-model="ctrl.userDto.contrasena"
									...
									placeholder="Ingrese una contrasena" required ng-minlength="2" />
								<div class="has-error" ng-show="myForm.$dirty">
									<span ng-show="myForm.contrasena.$error.required">Requiere
										...
										caracteres permitido son 2</span> <span
					...
					<div class="row">
						<div class="form-group col-md-12">
							...
							<div class="col-md-7">
								<input type="password" ng-model="ctrl.userDto.contrasenaNueva"
									name="contrasena" class="contrasena form-control input-sm"
									placeholder="Ingrese una contrasena" required ng-minlength="2" />
								<div class="has-error" ng-show="myForm.$dirty">
									<span ng-show="myForm.contrasena.$error.required">Requiere
								...
								<div class="modal-content">
									<div class="modal-header">
										...
										<p
											...
											<strong>{{r.codRespuesta}} : Contraseña actualizada</strong>
										...
										<p
											...
											<strong>{{r.codRespuesta}} : No se ha actualizado la contraseña</strong>
										...
										<p
											...
											<button type="button" class="btn btn-default"
												data-dismiss="modal"
												onclick="javascript:location.href='http://localhost:8089/JodaAutenticacion/actualizar/'">Close</button>
										</p>
	...
	<script src="<c:url value='/static/js/service/actualizar_service.js' />"></script>
	<script
		src="<c:url value='/static/js/controller/actualizar_controller.js' />"></script>
</body>
</html>